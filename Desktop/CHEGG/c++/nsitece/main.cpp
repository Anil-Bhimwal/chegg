...
int main()
{
    ...
    if(conn){
         ...
         cout<<"Enter student studentid :"<<endl;cin>>Student_id;
         cout<<"Enter name "<<endl; cin>>Name;
         cout<<"Enter rollno No: "<<endl; cin>>Roll_no;
    ...
    if(!qstate)
    {
        ...
        {
            cout<<"Student studentid :"<<row[0]<<" "<<endl;
            cout<<"Student Name :"<<row[1]<<" "<<endl;
            cout<<"Student rollno NO :"<<row[2]<<" "<<endl;
